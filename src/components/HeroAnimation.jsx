...
export default function HeroAnimation() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-white">
      ...
      {/* WHITE OVERLAY */}
      <div
        className={`absolute inset-0 bg-white z-40 transition-opacity duration-700 ${
      ...
      <div className="absolute inset-0 z-30 pointer-events-none">
        ...
        {/* TOP CARD */}
        <div
          className={`absolute top-0 left-0 w-full h-1/2 flex flex-col items-center justify-center bg-white
        ...
        >
          ...
          <p className="text-[11px] tracking-[3px] text-gray-500 uppercase">
        ...
        {/* BOTTOM CARD */}
        <div
          className={`absolute bottom-0 left-0 w-full h-1/2 flex flex-col items-center justify-center bg-white
          transition-transform duration-[1800ms] ease-[cubic-bezier(0.76,0,0.24,1)]
          ${start ? "translate-y-full" : "translate-y-0"}`}
        >
          ...
          <p className="text-[13px] text-gray-500">
            An offering in the sky by E infra and PVR
          </p>
        </div>
